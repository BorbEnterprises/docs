...
# Notes
These objectives are typically used in conjunction with a [followdistance](/hitandrun/scripting/conditions/followdistance.md) condition in order to require the player to maintain a certain distance between themselves and the vehicle.
