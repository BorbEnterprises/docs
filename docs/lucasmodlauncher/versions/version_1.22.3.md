...
description: "This update was released on April 11th, 2019."
...
* Fixed a [crash](/img/lucasmodlauncher/misc/wine_appid_crash.png) on startup when using Wine (and not using "-noappid").
...
A new template language (Template_1.22.3.xml) was published on [this page](../localisation.md) including this new language string at the end of the file.
