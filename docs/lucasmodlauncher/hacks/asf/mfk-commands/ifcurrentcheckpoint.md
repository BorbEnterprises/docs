...
Additionally, **this must be called after** [CHECKPOINT_HERE](checkpoint_here.md).
...
# Notes
Conditional commands and the `{ }` syntax for conditional blocks are both unused functionality that Radical provides, it was not created from the ground up by us.
