...
description: "A versatile chunk type that contains a XYZ position in the world and, depending on the type, various other kinds of data."
authors: [ 2 ]
---

A versatile chunk type that contains a XYZ position in the world and, depending on the type, various other kinds of data.
