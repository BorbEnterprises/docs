---
title: "Included Mods"
description: "This page explains what the various mods included with the Mod Launcher do."
authors: [ 2 ]
---
...
Removes the delay on the license screen using the [[../Hacks/CustomLicenseScreenTime.md]] hack.
...
Makes your car get repaired when resetting to the road using the game's `MANUALRESETDAMAGE` [[/TheSimpsonsHitAndRun/CommandLineArguments.md|command line argument]].
