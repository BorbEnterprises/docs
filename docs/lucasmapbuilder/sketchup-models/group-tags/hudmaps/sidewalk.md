---
title: Sidewalk
description: "This tag makes a group's geometry get included in the HUD Map Mesh with the same color Radical used to represent sidewalks (a medium gray color)."
status:
    class: "wip"
summary:
    initialVersion: "1.0"
...
This tag makes a group's geometry get included in the HUD Map [Mesh](../../../xml-format/elements/entities/mesh.md) with the same color Radical used to represent sidewalks (a medium gray color).
