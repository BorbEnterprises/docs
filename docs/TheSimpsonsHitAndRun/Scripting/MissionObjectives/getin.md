...
# Notes
* If using a car as the second argument to [[../ConsoleCommands/AddObjective.md]] as outlined in the forced car example, the car must exist when the MFK script is loaded. If the vehicle does not exist at this time, this argument will be ignored.
* If using a car as the second argument to [[../ConsoleCommands/AddObjective.md]] as outlined in the forced car example, "getin" and the car's name must be the only two arguments, no arrow flags can be specified.