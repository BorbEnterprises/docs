...
* Removed the **Show Windows Cursor** setting.
	* This caused issues with the new [[/LucasSimpsonsHitAndRunModLauncher/Hacks/DearImgui.md]] hack.
...
* Removed the F8 key that toggled the HUD.
	* This is now apart of the [[/LucasSimpsonsHitAndRunModLauncher/Hacks/DeveloperKeys.md]] hack.
