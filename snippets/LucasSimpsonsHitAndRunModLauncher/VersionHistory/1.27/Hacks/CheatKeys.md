...
* Replaced the `-forceallowcheatkeys` command line argument with a new **Force Allow Cheat Keys** setting.
* Now disables the **Reset Hit & Run Meter** key when Multiplayer is enabled.
